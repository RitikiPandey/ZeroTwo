    ...
    return (
        <div className="flex flex-col items-center justify-center text-center absolute h-full w-full gap-y-24">
            ...
            <div className="text-2xl w-3/6 flex items-center flex-col gap-12">
                <p>ZeroTwo connects everyone in the production process of animation so the team can deliver better results, faster.</p>
                {/* { !user && ( */}
                {(
                    <a className="block text-center px-3 py-2 rounded-md bg-sky-500 text-white w-3/12" href="/login" >Get Started</a>
                )}
                </div>
        </div>
    )
